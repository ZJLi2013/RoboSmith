...
Usage:
    python scripts/assets/compute_stable_poses.py                    # all assets
    python scripts/assets/compute_stable_poses.py --name mug_01      # single asset
    python scripts/assets/compute_stable_poses.py --dir assets/objects/mug_01
    python scripts/assets/compute_stable_poses.py --dry-run           # preview only
"""
