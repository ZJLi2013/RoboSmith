...
- **Node**: smc300x-clt-r4c11-02 (MI308X) or banff-sc-cs41-29 (MI300X)
...
- **Node**: smc300x-clt-r4c11-02 (AMD Instinct MI308X)
...
- **Node**: banff-sc-cs41-29 (AMD Instinct MI308XHF x8, /data 2.4T)
- **Docker**: rocm/pytorch:rocm6.4.3_ubuntu24.04_py3.12_pytorch_release_2.6.0
...
- GPU: AMD Instinct MI308XHF, 206.1 GB VRAM
...
- **Node**: banff-sc-cs41-29 (MI308XHF, /data 2.3T free)
...
**PASS** — 约束 prompt 版 E2E 管线在 MI308X + ROCm 6.4 上验证通过。
...
- **Node**: banff-sc-cs41-29 (MI308XHF)
