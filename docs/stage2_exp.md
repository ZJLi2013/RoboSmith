...
python pipeline/collect_data.py --n-episodes 100 --object mug_tall_ceramic \
    --repo-id local/stage2-mug-train --seed 42

python pipeline/collect_data.py --n-episodes 100 --object mug_short_metal \
    --repo-id local/stage2-mug-train --seed 43 --append

python pipeline/collect_data.py --n-episodes 100 --object mug_handleless_white \
